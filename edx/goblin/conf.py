...
BLOG_AUTHOR = "Senthil Kumaran"  # (translatable)
BLOG_TITLE = "Grammar Goblin"  # (translatable)
...
BLOG_EMAIL = "senthil@uthcode.com"
BLOG_DESCRIPTION = "https://courses.edx.org/courses/course-v1:UQx+Write101x+2T2015/info"  # (translatable)
